...
private:
    ...
    void RemoveMutualFriendship(User* userToBeDeleted);
    void bubbleSort(LinkedList<Video*> *ptr);
    void swap(Video** vidptr1,Video** vidptr2);
    bool isNotCheckedBefore(LinkedList<string>* list, string &username);
    bool isConnectedHelper(LinkedList<string>* list, User* currFriend, string key);
